...
<!--注册开始-->
    <div class="reg">
        <form action="reg_result.php" method="post" name="form1" id="form1">
            <dl>
                <dt class="f14 b">賬號基本信息</dt>
                <dd><span class="title">登入賬號：</span><input class="reg_input" name="t_UserName" id="t_UserName" onblur="checkusername(this.value);" type="text" /><span id="t_UserNameTip" class="onshow"></span></dd>
                <dd><span class="title">姓名：</span><input class="reg_input" name="iptNickName" id="iptNickName" onblur="checkNickName(this.value)" type="text" /><span id="iptNickNameTip" class="onshow"></span></dd>
                <dd><span class="title">性別：</span><input type="radio" id="Sex_Man" name="rb_Sex" value="男" checked="CHECKED" /><label for="Sex_Man"> 帅哥</label>
                                                    <input type="radio" id="Sex_Woman" name="rb_Sex" value="女" /><label for="Sex_Woman"> 美女</label>　
              </dd>
            </dl>
            <dl>
                <dt class="f14 b">賬號安全設置</dt>
                <dd><span class="title">登入密码：</span><input class="reg_input" onblur="return checkpasswd(this);" id="t_UserPass" name="t_UserPass" type="password"/><span id="t_UserPassTip" class="onshow"></span></dd>
                <dd><span class="title">確認登入密碼：</span><input onblur="checkdoublepassword();" class="reg_input" type="password" id="t_RePass" name="t_RePass"/><span id="t_RePassTip" class="onshow"></span></dd>
                <dd><span class="title">聯繫地址：</span><input name="iptName" id="iptName" class="reg_input" type="text" onblur="return isCnn(this)" /><span id="iptNameTip" class="onshow"></span></dd>
                <dd><span class="title">身份證號：</span><input class="reg_input" name='iptCard' type='text' id='iptCard' onblur="return checktheform();" /><span id="iptCardTip" class="onshow"></span></dd>
                <dd><span class="title">郵箱地址：</span><input class="reg_input" name="t_Email" type="text" id="t_Email" onblur="checkemail(this.value)" /><span id="t_EmailTip" class="onshow"></span></dd>
            </dl>
            <div class="f_reg_but"><input id="button" name="button" type="submit" value="加入e-lib" class="r_button"/><span class="clew_txt">如果您已有賬號<a href="../login/" target="_parent">直接登錄</a></span></div>
        </form>                              
    </div>
<!--注册结束-->        
</body>
